...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        if(request()->ajax()){
            ...
            $orders=payment_log::whereHas('author')->where('post_status','!=','trash')->type('order_request')->orderBy('id',$sort)->when('request',function($q){
			...
			return datatables()->of($orders)->addColumn('name',function($orders){
                ...
                return $orders->payment_status.' '.$orders->payment_status ;
            })->make(true);
