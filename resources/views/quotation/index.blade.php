...
@endpush
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Quotation')}}</h5>
                            <span>{{ __('List of User Quotation')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header"><h3>{{ __('Quotation')}}</h3></div>
                    <div class="card-body">
                ...
                columnDefs:[
                    {
                        ...
                        'render': function ( data, type, row, meta ) {
                            @php 
                            $user=\App\Models\User::Role('Team Member')->get();    
                            @endphp
                            var user={!!$user->toJson()!!}||[];
                            var html='<select name="assign_to" class="form-control" data-id="'+row.ID+'">';
                                html+='<option>N/A</option>';
                                if(user.length>0){
                                    $.each(user,function(i,v){
                                        html+='<option value="'+v.id+'" '+(v.id==row.assigned_user_id?'selected':'')+'>#'+v.id+' '+v.name+'</option>';
                                    });
                                }
                            html+='</select>';
                            return html;
