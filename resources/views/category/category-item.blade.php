...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Category Items')}}</h5>
                            <span>Add, remove or edit category items</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                        ...
                        <div class="d-block d-md-inline-block">
                            <div class="btn-group float-md-left mr-1 mb-1">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ url()->current().'?'.http_build_query(array_merge(request()->all(),['sort' => 'desc'])) }}">{{ __('ASC')}}</a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 list-item list-item-thumb">
                            <div class="card d-flex flex-row mb-3">
                                <a class="d-flex card-img" href="#categoryView" data-toggle="modal" data-target="#categoryView">
                                    <img src="{!! asset('img/portfolio-1.jpg') !!}" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0 d-none">
                                    
                                    
                                    <span class="badge badge-pill badge-success position-absolute badge-top-left">{{$items->category->item_name }} items</span>
                                </a>
                                <div class="d-flex flex-grow-1 min-width-zero card-content">
                                    <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center mb-0">
                                        ...
                                        <div class="w-15 w-xs-100">
                                            <span class="badge badge-pill badge-secondary">{{$items->category->item_name }}</span>
                                        </div>
                                        <div class="w-15 w-xs-100">
                                    ...
                                    <div class="list-actions">
                                        ...
                                        <a href="{{ route('category.item.show',$items->id) }}" class="list-delete"><i class="ik ik-trash-2"></i></a>
                                    </div>
                ...
                {{ $category_items->appends(request()->input())->links() }}
            </div>
        </div>
    </div>
    <!-- category add modal-->
        ...
        <div class="modal-dialog w-300" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryAddLabel">{{ __('Add Category Item')}}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="item_title" class="form-control" placeholder="Enter Item Title">
                    </div>
                    <div class="form-group">
                        <label class="d-block">Form Name Prefix(Optional)</label>
                        <input type="text" name="item_form_name" class="form-control" placeholder="Enter Name Prefix">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="d-block">Volume in CFT</label>
                        <input type="number" name="cft" class="form-control" placeholder="Enter volume in cft">
                    </div>
    ...
    <div class="modal fade edit-layout-modal pr-0 " id="categoryView" tabindex="-1" role="dialog" aria-labelledby="categoryViewLabel" aria-hidden="true">
        <div class="modal-dialog w-300" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryViewLabel">{{ __('Edit Category Item')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                <form>    
                    ...
                    <div class="form-group">
                        <label class="d-block">Item Title</label>
                        <input type="text" name="item_title" class="form-control" placeholder="Enter Category Title">
                    </div>
                    <div class="form-group">
                        <label class="d-block">Form Name Prefix(Optional)</label>
                        <input type="text" name="item_form_name" class="form-control" placeholder="Enter Name Prefix">
                    ...
                    <div class="form-group">
                        <label class="d-block">Volume in CFT</label>
                        <input type="text" name="cft" class="form-control" placeholder="Enter volume in cft">
                    </div>
        ...
        <script>
            $(function(){
                ...
                $('#categoryView').on('show.bs.modal', function (e) {
                    ...
                    $('#categoryView form').append('<input type="hidden" name="item_id" value="'+data.id+'">');
                    $('#categoryView form input[name="item_title"]').val(data.item_title);
                    $('#categoryView form input[name="item_form_name"]').val(data.item_form_name);
                    $('#categoryView form input[name="cft"]').val(data.cft);
                    $('#categoryView form select[name="category"] option[value="'+data.item_category+'"]').prop('selected', 'selected').change();
                ...
                $('#categoryView').on('hide.bs.modal', function (e) {
                    var data=$(e.relatedTarget).data('edit');
                    $('#categoryView form input[name="item_title"]').val('');
                    $('#categoryView form input[name="item_form_name"]').val('');
                    $('#categoryView form input[name="cft"]').val('');
