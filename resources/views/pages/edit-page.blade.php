        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <input type="text" class="form-control" id="post_title" name="post_title" value="{!! $page->post_title !!}" placeholder="Title">
                    </div>
                    <div class="card-header"><h3>{{ __('Content')}}</h3></div>
                    <div class="card-body">
                        <div class="form-group">
                            <textarea class="form-control html-editor" rows="10" name="post_content">{{$page->post_content}}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="post_status" class="form-control">
                                @if(count($post_status)>0)
                                    ...
                                    <option {{ ($value==$page->post_status)?'selected':'' }}>{{$value}}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
